...
awful.util.tagnames = { "   Web ", "   Dev ", " ﬑  Term ", "   Github ", "   Files ", "   Chat ", " 阮  Spotify " }
...
globalkeys = my_table.join(
    ...
    {description = "show dmenu", group = "Antobio Shortcuts"}),
   ...
   -- awful.key({ modkey }, "Right", function () lain.util.tag_view_nonempty(1) end,
    ...
    awful.key({ modkey, "Shift"   }, "j", function () awful.client.swap.byidx(  1)    end,
              {description = "swap with next client by index", group = "Antobio Shortcuts Layout"}),
    awful.key({ modkey, "Shift"   }, "k", function () awful.client.swap.byidx( -1)    end,
              {description = "swap with previous client by index", group = "Antobio Shortcuts Layout"}),
    ...
    awful.key({ altkey, "Shift"   }, "l",     function () awful.tag.incmwfact( 0.05)          end,
              {description = "increase master width factor", group = "Antobio Shortcuts Layout"}),
    awful.key({ altkey, "Shift"   }, "h",     function () awful.tag.incmwfact(-0.05)          end,
              {description = "decrease master width factor", group = "Antobio Shortcuts Layout"}),
    ...
    awful.key({ modkey,           }, "space", function () awful.layout.inc( 1)                end,
              {description = "move window", group = "Antobio Shortcuts Layout"}),
    ...
    -- awful.key({ }, "XF86AudioRaiseVolume",
        function ()
            os.execute(string.format("amixer -q sset Master 2dB+", beautiful.volume.channel))
            beautiful.volume.update()
        end,
                {description = "volume UP", group = "Antobio Shortcuts System"}),
    ...
    -- awful.key({ }, "XF86AudioLowerVolume",
        function ()
            ...
            beautiful.volume.update()
                ...
                {description = "volume DOWN", group = "Antobio Shortcuts System"}),
...
clientkeys = my_table.join(
    ...
    awful.key({ modkey, altkey   }, "c",      function (c) c:kill()                         end,
              {description = "Close window", group = "Antobio Shortcuts"}),
    awful.key({ modkey, "Shift" }, "space",  awful.client.floating.toggle                     ,
              {description = "toggle floating", group = "client"}),
    awful.key({ modkey, "Control" }, "Return", function (c) c:swap(awful.client.getmaster()) end,
              {description = "move to master", group = "Antobio Shortcuts Layout"}),
